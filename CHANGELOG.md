...
- Deterministic chat import slice on draft PR #17: importer `a94042d1fc5dc2b013261167c26c96c5d433fac2`, CLI `24b10ae585bcd52bc87c0ff7cc20922e00d7ae0f`, structural replay comparison `becd258ef396e43732816fdc6d0ae5055c5fe6d8`, service-backed tests `abc559a7593d657a373cd645eea90295268f4ca0`.
- PR #17 implementation-head CI `32367095289` passed release-control document checks, PostgreSQL service/client verification, `npm ci`, tests, lint, typecheck, production build, and production dependency audit.
...
- This import slice proves validation, dry-run behavior, exact ordinary replay idempotency, and conflicting-replay failure against PostgreSQL CI; it does not prove concurrent import serialization.
- Import resumability/checkpointing, interruption/restart recovery, production cutover, and explicit rollback verification remain incomplete.
