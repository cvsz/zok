...
- The new metadata persistence boundary is not wired into live Express read/tag/message side effects in this slice; JSON therefore remains the live owner of metadata/unread/tags even when the PostgreSQL boundary exists.
...
- The PostgreSQL metadata boundary is verified but is not yet the live Express owner of chat metadata/unread/tags.
